...
async def draw_pl2(session,server_id,gameId,remid, sid, sessionID):
    ...
    if len(stat3) != 0:
        ...
        for i in range(len(stat3)):
            ...
            f.write('{\n"slot": %d,\n"rank": %d,\n"kd": %f,\n"kp": %f,\n"id": %s\n},\n'%(i+65,stat3[i]['rank'],stat3[i]['killDeath'],stat3[i]['killsPerMinute'],stat3[i]['id']))
    ...
    if len(stat4) != 0:
        ...
        for i in range(len(stat4)):
            ...
            f.write('{\n"slot": %d,\n"rank": %d,\n"kd": %f,\n"kp": %f,\n"id": %s\n},\n'%(i+69,stat4[i]['rank'],stat4[i]['killDeath'],stat4[i]['killsPerMinute'],stat4[i]['id']))
