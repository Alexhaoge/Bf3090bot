...
HTML_FOLDER = Path(__file__).parent.parent.joinpath('assets')
...
with open(HTML_FOLDER / 'template.html', encoding='utf-8') as f:
    MAIN_TEMPLATE = f.read()

with open(HTML_FOLDER / 'template2042.html', encoding='utf-8') as f:
    MAIN2042_TEMPLATE = f.read()

with open(HTML_FOLDER / 'weapon_card.html', encoding='utf-8') as f:
    WEAPON_CARD = f.read()

with open(HTML_FOLDER / 'vehicle_card.html', encoding='utf-8') as f:
    VEHICLE_CARD = f.read()

with open(HTML_FOLDER / 'classes_card.html', encoding='utf-8') as f:
    CLASSES_CARD = f.read()

with open(HTML_FOLDER / 'src.js', encoding='utf-8') as f:
    SRC = f.read()

with open(HTML_FOLDER / 'style.css', encoding='utf-8') as f:
    STYLE = f.read()
